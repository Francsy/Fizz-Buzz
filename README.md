...
## Introduction ##
![I've written fizzbuzz in 1500 lines](fizzbuzz.png)

The nightmare of many programmers when facing a job interview, perhaps due to its complex algorithm or simply due to its unusual reasoning.

Either way, you are sure to be able to do it!!
...
## Iterations ##
![Give me a fizzbuzz in a few lines of code](giveMe.png)

Print all the numbers from 1 to 1000 to the console, with the exception of all those numbers that are multiples of 3, which will be printed as Fizz instead of the number, and for numbers that are multiples of 5, Buzz will be printed. Additionally, for numbers that are multiples of both 3 and 5, FizzBuzz will be printed.
